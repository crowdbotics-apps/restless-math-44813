"""
Django settings for restless_math_44813 project.
...
ROOT_URLCONF = 'restless_math_44813.urls'
...
WSGI_APPLICATION = 'restless_math_44813.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_math_44813 API",
    "DESCRIPTION": "API documentation for restless_math_44813 App",
    "VERSION": "v1",
}
